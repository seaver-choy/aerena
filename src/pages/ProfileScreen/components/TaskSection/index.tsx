            ...
            if (!userQuest.isClaimed && quests !== null) {
                ...
                if (!quests[currentQuestIndex].isRepeating)
                    switch (value) {
                        case null:
                            if (
                                user[quests[currentQuestIndex].taskName] != null
                            ) {
                        ...
                        default:
                            if (
                                user[quests[currentQuestIndex].taskName] >=
                                quests[currentQuestIndex].value
                            ) {
                                quests[currentQuestIndex].isClaimable = true;
                            }
                            break;
            ...
            switch (quest.taskName) {
                ...
                case "joinedTheBoboBot":
                    ...
                    utils.openTelegramLink(
                        "https://t.me/AngBoboBot/bobo?startapp=ref-1947935016"
                    );
                    break;
                case "friends":
                case "referredBy":
