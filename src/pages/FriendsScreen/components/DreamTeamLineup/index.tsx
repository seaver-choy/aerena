        ...
        <div className="w-full">
            ...
            <div className="absolute top-[25vw] flex flex-row flex-wrap items-center justify-center gap-[4vw]">
                {positionList.map((position, index) => (
                    <div key={index}>
                        {((positionChange && currentPositionIndex === index) ||
                            (teamChange &&
                            ...
                            dreamTeamLineup[index].athlete !== null && (
                                ...
                                >
                                    <AthleteCard
                                        ...
                                        id={index + 100} //extra value for multiple athlete cards of the same one in this part
                                    />
                                </motion.div>
                            )}
                    </div>
                ...
                {showAthleteSelectModal && (
                    <AthleteSelectModal
                        ...
                        onClose={closeAthleteSelectModal}
                    />
                )}
            </div>
        </div>
