        ...
        <div className="mt-[4vw] bg-graydark">
            <div className="relative flex h-[42vw] w-full justify-center">
                ...
                <div className="absolute top-[4vw] flex flex-col items-center">
                    ...
                    <motion.div className="mt-[2vw]" {...appearTextAnimation}>
                ...
                <div className="absolute left-[6vw] top-[12vw] h-[10vw] w-[26vw]">
                    <TeamCard color={color} team={"ANRCHY"} />
                </div>
                <div className="absolute bottom-[12vw] left-[6vw] flex h-[6vw] w-[26vw] justify-center pl-[5vw]">
                    <img className="h-full" src={LoseLeft} />
                    <img className="-ml-[2vw] h-full" src={WinLeft} />
                    <img className="-ml-[2vw] h-full" src={WinLeft} />
                </div>
                <div className="absolute right-[6vw] top-[12vw] h-[10vw] w-[26vw]">
                    <TeamCard color={color} team={"ANRCHY"} />
                </div>
                <div className="absolute bottom-[12vw] right-[6vw] flex h-[6vw] w-[26vw] justify-center pr-[5vw]">
