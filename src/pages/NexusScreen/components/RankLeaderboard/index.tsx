                            ...
                            >
                                <div className="relative flex h-full w-full">
                                    ...
                                    <div className="absolute flex h-full w-full flex-col items-center justify-center overflow-hidden">
                                        <p className="mt-[0.6vw] bg-gradient-to-b from-golddark via-goldlight to-golddark bg-clip-text font-russoone text-[2vw] font-normal text-transparent will-change-transform backface-hidden">
                                            ASSISTS
                                        </p>
